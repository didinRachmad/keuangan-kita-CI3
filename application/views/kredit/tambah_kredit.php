                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datepicker" id="tanggal_transaksi" name="tanggal_transaksi" autocomplete="off" value="">
                            ...
                            <a href="<?= base_url(); ?>keuangan/kredit" class="btn btn-danger">Kembali</a>
